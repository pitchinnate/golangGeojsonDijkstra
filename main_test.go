...
func TestFindPath(t *testing.T) {
	t.Run("Test FindPath Small Dataset", func(t *testing.T) {
		...
		path, err := fc.FindPath(Position{-84.396863, 33.792908}, Position{-84.396535, 33.792578}, 0.00001)
		if err != nil {
	...
	t.Run("Test FindPath Large Dataset", func(t *testing.T) {
		...
		json.Unmarshal(text, &fc)
		path, err := fc.FindPath(Position{-84.397252, 33.792997}, Position{-84.395111, 33.791666}, 0.00001)
		if err != nil {
			t.Errorf("returned an error %s", err)
		}
		if len(path) != 27 {
